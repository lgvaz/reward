...
from reward.utils import get_obj, Config
from reward.nn import SequentialExtended
...
def nn_from_config(config, state_info, action_info, body=None, head=None):
    ...
    Returns
    -------
    reward.SequentialExtended
        A reward NN (basically a pytorch NN with extended functionalities).
    """
    if body is None:
